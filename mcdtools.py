...
def plot_temp_profile(mcddata, title=True, *args, **kwargs):
...
def plot_pres_profile(mcddata, title=True, *args, **kwargs):
...
def plot_dens_profile(mcddata, title=True, *args, **kwargs):
...
def plot_data_overview(mcddata, title = False, legend = False, *args, **kwargs):
    ...
    plt.subplot(221)
    plot_temp_profile(mcddata, title=False, *args, **kwargs)
    plt.subplot(222)
    plot_pres_profile(mcddata, title=False, *args, **kwargs)
    plt.subplot(223)
    plot_dens_profile(mcddata, title=False, *args, **kwargs)
    plt.subplot(224)
    plot_shield_depth_profile(mcddata, title=False, *args, **kwargs)
    if title:
